    ...
    >
      <div className="max-w-4xl mx-auto px-6 sm:px-8 md:ml-0 space-y-12">
        ...
        <motion.div
          ...
          variants={itemVariants}
        >
          <p className="text-lg sm:text-xl tabletAndBelow:text-base text-gray-300 leading-relaxed">
          ...
          <div className="flex flex-col space-y-8 pt-4">
            <motion.a
              ...
              className="flex items-center gap-3 text-lg sm:text-xl text-gray-300 hover:text-white transition-colors underline underline-offset-4 decoration-gray-500 hover:decoration-gray-400 group"
              variants={itemVariants}
            >
            ...
            <motion.a
              ...
              variants={itemVariants}
            >
              <svg className="w-5 h-5 sm:w-6 sm:h-6 text-gray-400 group-hover:text-white transition-colors flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
              </svg>
              <span>View my LinkedIn profile</span>
              <svg className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0 text-gray-500 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
