            ...
            <div className="px-1 text-slate-300 text-sm">
                <div className="p-6 flex items-start justify-between gap-1 text-right mobile:text-left mobile:flex-col mobile:gap-4 ">
                    ...
                    <div className="flex flex-col items-end [&_p]:py-[0.15rem] max-w-[600px]">
                        ...
                        <p>
                            I acknowledge traditional owners of Country throughout the unceded lands of Australia. I pay respect to the Widjabul Wiyebal people of the Bundjalung Nation custodians of the land on which I live and recognise their connection to land, water and community.
                        </p>
                    </div>
                </div>
            </div>
